...
interface IInstituicao
{
    ...
    public function create(int $adm_id, string $nome_fantasia, string $razao_social, string $sub_domain, string $email, string $cnpj, string $telefone, string $recebedor_id, $cor, string $logo): void;
