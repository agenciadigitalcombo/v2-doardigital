							...
							<!--begin::Details-->
										...
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
											...
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="#/perfil-edita">Dados do Perfil</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item mt-2">
											...
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5" href="#/editar-securanca">Ativar Assinatura</a>
											</li>

											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5" href="#/editar-securanca">Criar Instituição</a>
											</li>										
												<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5" href="#/editar-securanca">Criar Planos</a>
											</li>										
												<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5" href="#/editar-securanca">Configurar E-mails</a>
											</li>
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5" href="#/editar-securanca">Notificações</a>
											</li>
											<!--end::Nav item-->
										</ul>
										<!--begin::Navs-->
								...
								<form id="kt_account_profile_details_form" class="form">
									...
									<div class="card-body border-top p-9">
										...
										<div class="row mb-6">
											...
											<div class="col-lg-8">
												<!--begin::Image input-->
												<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(../painel/assets/image/gravatar.png)">
													<!--begin::Preview existing avatar-->
													<div class="image-input-wrapper w-125px h-125px" style="background-image: url(../painel/assets/image/gravatar.png)"></div>  
										...
										<div class="row mb-6">
											...
											<!--begin::Col-->
											<div class="col-lg-8 fv-row">
												<input type="text" name="nascimento" class="form-control form-control-lg form-control-solid" placeholder="dd/mm/aaaa"  />
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
